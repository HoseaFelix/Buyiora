...
export function renderPayementSummary(){
    ...
    const totalBeforeTaxCents = productPriceCents + shippingPriceCent;
    const taxCents = totalBeforeTaxCents * 0.1;
    const totalCents = totalBeforeTaxCents + taxCents;


    const renderPayementSummaryHtml = `
    ...
    document.querySelector('.js-payment-summary').innerHTML = renderPayementSummaryHtml
